...
<template>
    <div id="MainLayout" class="w-full h-screen">
        ...
        >
            <Link href="/">
                <img
                    class="xl:hidden block w-[25px] mt-10 ml-[25px] mb-10 curdor-pointer"
                    src="/insta-logo-small.png"
                />
                <img
                    class="xl:block hidden w-[120px] mt-10 ml-6 mb-10 curdor-pointer"
                    src="/insta-logo.png"
                />
            </Link>
        ...
        >
            <div
                ...
                :class="
                    $page.url === '/' ? 'lg:w-2/3 w-full' : 'max-w-[1200px]'
                "
            >
                <main>
                    <slot />
            ...
            <div
                ...
                class="lg:w-1/3 lg:block hidden mt-10 text-black"
            >
                <Link
                    :href="
                        route('users.show', { id: $page.props.auth.user.id })
