            ...
            <div class="ml-6 w-full">
                ...
                <div class="md:block hidden">
                    <div class="flex items-center text-[18px]">
                        <div class="mr-6">
                            <span class="font-extrabold"> {{ postsByUser.data.length }} </span>
                            posts
                        </div>
                        <div class="mr-6">
                            <span class="font-extrabold"> 13 </span>
                            followers
                        </div>
                        <div class="mr-6">
                            <span class="font-extrabold"> 13 </span>
        ...
        <div id="ContentSection" class="md:pr-1.5 lg:pl-0 md:pl-[90px]">
            ...
            <div class="grid md:gap-4 gap-1 grid-cols-3 relative">
                <div v-for="postByUser in postsByUser.data" :key="postByUser">
                    <ContentOverlay :postByUser="postByUser" @selectedPost="$event => data.post = $event" />
                </div>
            </div>
