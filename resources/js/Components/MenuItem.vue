...
<template>
    <div class="w-full xl:inline-block xl:hover:bg-gray-100 p-2 rounded-full transition duảtion-300 ease-in-out cursor-pointer">
        <div class="flex items-center">
            <img v-if="iconString === 'Profile'" :class="{'mr-1': iconString === 'Profile'}" class="rounded-full ml-[2px] w-[30px] cursor-pointer" :src="user.file">
